...
<div class="section" id="loginSection" style="display: block; max-width: 400px; margin: 0 auto;">
  ...
  <div style="margin-bottom: 20px; position: relative; height: 48px;">
      ...
      <button id="loginBtn" style="width: 100%; padding: 12px; background-color: #52c41a; color: white; border: none; border-radius: var(--radius); cursor: pointer; font-size: 16px; font-weight: bold; height: 48px; box-sizing: border-box; position: absolute; top:0; left:0;">登录</button>
  </div>
